...
<?php		
	...
	public function call_menu ($typ) {
      ...
      if (in_array(14, $this->user_permissao)) echo '<a class="rt_lftmn'.(($typ == 14) ? ' rt_lnkmn' : '').'" href="produtos.php"><i class="fa fa-shopping-cart fa-2x"></i> <span class="hidden-xs rt_lfttxt">'.$this->get_string(113).'</span></a>';
      if (in_array(15, $this->user_permissao)) echo '<a class="rt_lftmn'.(($typ == 15) ? ' rt_lnkmn' : '').'" href="compras.php"><i class="fa fa-money fa-2x"></i> <span class="hidden-xs rt_lfttxt">'.$this->get_string(120).'</span></a>';
