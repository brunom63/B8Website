...
$website->item_id = $website->db_validate('sdk_posts');

$website->modules_list = array('datetimepicker', 'ckfinder', 'multiupload-e', 'multifileupload-e');
...
$website->form_populate = array(
    ...
    'frm12' => array('hugtext', FALSE, 'Código'),
    'frm13' => array('bigtext', FALSE, 'Campo 1'),
    'frm14' => array('bigtext', FALSE, 'Campo 2'),
    'frm15' => array('bigtext', FALSE, 'Campo 3'),
    'frm16' => array('bigtext', FALSE, 'Campo 4'),
...
if ($website->form_checktrigger()) {
	...
	if ($website->form_status == 'ALLOW') {			
		// STRING FOR DATABASE
		$sql = "UPDATE sdk_posts SET dt_categoria=".$website->form_values['frm2n'].", dt_titulo='".$website->form_values['frm10']."', dt_alias='".$website->form_values['frm7']."', dt_autor='".$website->form_values['frm1']."', dt_data_inicio=".$website->form_values['frm3n'].", dt_data_fim=".$website->form_values['frm4n'].", dt_ativado=".$website->form_values['frm5'].", dt_destaque=".$website->form_values['frm6'].", dt_alterado_data=".$website->data_hj.", dt_corpo='".$website->form_values['frm11']."', dt_galeria='".$website->form_values['frm20n']."', dt_arquivos='".$website->form_values['frm30n']."', dt_codigo='".$website->form_values['frm12']."', dt_campo1='".$website->form_values['frm13']."', dt_campo2='".$website->form_values['frm14']."', dt_campo3='".$website->form_values['frm15']."', dt_campo4='".$website->form_values['frm16']."', dt_meta_descricao='".$website->form_values['frm8']."', dt_meta_tags='".$website->form_values['frm9']."' WHERE ".$website->db_id."=".$website->item_id;
		$website->sql_db($sql);					
...
$query = "SELECT * FROM sdk_posts WHERE ".$website->db_id."=".$website->item_id;
    ...
    <div class="col-xs-10">
	  <div class="row">
    	<div class="col-xs-12 rt_cnttit">
          <h1><i class="fa fa-clipboard fa-2x"></i><span class="rt_cnttxt"><?php echo $website->get_string(3); ?></span> <small><?php echo $website->get_string(16); ?></small><?php $website->call_back('posts.php'); ?></h1>
        </div>
      </div>
      <div class="row">
    	<div class="col-xs-12 rt_cntbdy">
          ...
          <form role="form" method="post" action="posts_editar.php?i=<?php echo $website->item[$website->db_hash]; ?>">
		  <div class="row">
			<div class="col-md-6">
          ...
          <div class="row">
			<div class="col-md-12 rt_e">
              ...
              <div class="form-group">
                <label for="frm12"><?php echo $website->get_string(56); ?></label>
                <textarea class="form-control" id="frm12" name="f_frm12" placeholder="<?php echo $website->get_string(56); ?>"><?php echo $website->form_fetchvalue('frm12', $website->item['dt_codigo']); ?></textarea>
              </div>
              <div class="form-group">
                <label class="control-label" for="frm13"><?php echo $website->get_string(52); ?></label>
                <input type="text" class="form-control" id="frm13" placeholder="<?php echo $website->get_string(52); ?>" name="f_frm13" value="<?php echo $website->form_fetchvalue('frm13', $website->item['dt_campo1']); ?>">
              </div>
              <div class="form-group">
                <label class="control-label" for="frm14"><?php echo $website->get_string(53); ?></label>
                <input type="text" class="form-control" id="frm14" placeholder="<?php echo $website->get_string(53); ?>" name="f_frm14" value="<?php echo $website->form_fetchvalue('frm14', $website->item['dt_campo2']); ?>">
              </div>
              <div class="form-group">
                <label class="control-label" for="frm15"><?php echo $website->get_string(54); ?></label>
                <input type="text" class="form-control" id="frm15" placeholder="<?php echo $website->get_string(54); ?>" name="f_frm15" value="<?php echo $website->form_fetchvalue('frm15', $website->item['dt_campo3']); ?>">
              </div>
              <div class="form-group">
                <label class="control-label" for="frm16"><?php echo $website->get_string(79); ?></label>
                <input type="text" class="form-control" id="frm16" placeholder="<?php echo $website->get_string(79); ?>" name="f_frm16" value="<?php echo $website->form_fetchvalue('frm16', $website->item['dt_campo4']); ?>">
              </div>
