...
if ($website->form_checktrigger()) {
	...
	if ($website->form_status == 'ALLOW') {			
		// STRING FOR DATABASE
		$sql = "INSERT INTO sdk_paginas VALUES (NULL, '".$website->db_hashfield('sdk_paginas')."', '".$website->form_values['frm2n']."', '".$website->form_values['frm10']."', '".$website->form_values['frm7']."', '".$website->form_values['frm1']."', ".$website->form_values['frm3n'].", ".$website->form_values['frm4n'].", '".$website->form_values['frm5']."', '".$website->form_values['frm6']."', ".$website->p_id.", ".$website->data_hj.", NULL, '".$website->form_values['frm11']."', NULL, NULL, NULL, '".$website->form_values['frm8']."', '".$website->form_values['frm9']."', 0)";
		$website->sql_db($sql);					
		
	    $website->page_redirect('paginas.php');
    }
    else {
    ...
    <div class="col-xs-10">
	  <div class="row">
    	<div class="col-xs-12 rt_cnttit">
          <h1><i class="fa fa-desktop fa-2x"></i><span class="rt_cnttxt"><?php echo $website->get_string(4); ?></span> <small><?php echo $website->get_string(15); ?></small><?php $website->call_back('paginas.php'); ?></h1>
        </div>
      </div>
      <div class="row">
    	<div class="col-xs-12 rt_cntbdy">
          ...
          <form role="form" method="post" action="paginas_inserir.php">
		  <div class="row">
			<div class="col-md-6">
