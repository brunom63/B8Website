    ...
    <div class="col-xs-10">
	  <div class="row">
    	<div class="col-xs-12 rt_cnttit">
          <h1><i class="fa fa-clipboard fa-2x"></i><span class="rt_cnttxt"><?php echo $website->get_string(3); ?></span> <small><?php echo $website->get_string(16); ?></small><?php $website->call_back('produtos.php'); ?></h1>
        </div>
      </div>
      <div class="row">
