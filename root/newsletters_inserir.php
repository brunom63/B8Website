    ...
    <div class="col-xs-10">
	  <div class="row">
    	<div class="col-xs-12 rt_cnttit">
          <h1><i class="fa fa-envelope fa-2x"></i><span class="rt_cnttxt"><?php echo $website->get_string(6); ?></span> <small><?php echo $website->get_string(15); ?></small><?php $website->call_back('newsletters.php'); ?></h1>
        </div>
      </div>
      <div class="row">
    	<div class="col-xs-12 rt_cntbdy">
          ...
          <form role="form" method="post" action="newsletters_inserir.php">
		  <div class="row">
			<div class="col-md-6">
