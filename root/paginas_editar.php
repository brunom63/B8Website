...
$website->item_id = $website->db_validate('sdk_paginas');
...
if ($website->form_checktrigger()) {
	...
	if ($website->form_status == 'ALLOW') {			
		// STRING FOR DATABASE
		$sql = "UPDATE sdk_paginas SET dt_categoria=".$website->form_values['frm2n'].", dt_titulo='".$website->form_values['frm10']."', dt_alias='".$website->form_values['frm7']."', dt_autor='".$website->form_values['frm1']."', dt_data_inicio=".$website->form_values['frm3n'].", dt_data_fim=".$website->form_values['frm4n'].", dt_ativado=".$website->form_values['frm5'].", dt_destaque=".$website->form_values['frm6'].", dt_alterado_data=".$website->data_hj.", dt_corpo='".$website->form_values['frm11']."', dt_meta_descricao='".$website->form_values['frm8']."', dt_meta_tags='".$website->form_values['frm9']."' WHERE ".$website->db_id."=".$website->item_id;
		$website->sql_db($sql);					
...
$query = "SELECT * FROM sdk_paginas WHERE ".$website->db_id."=".$website->item_id;
    ...
    <div class="col-xs-10">
	  <div class="row">
    	<div class="col-xs-12 rt_cnttit">
          <h1><i class="fa fa-desktop fa-2x"></i><span class="rt_cnttxt"><?php echo $website->get_string(4); ?></span> <small><?php echo $website->get_string(16); ?></small><?php $website->call_back('paginas.php'); ?></h1>
        </div>
      </div>
      <div class="row">
    	<div class="col-xs-12 rt_cntbdy">
          ...
          <form role="form" method="post" action="paginas_editar.php?i=<?php echo $website->item[$website->db_hash]; ?>">
		  <div class="row">
			<div class="col-md-6">
